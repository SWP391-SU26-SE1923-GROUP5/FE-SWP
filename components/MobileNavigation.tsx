...
const renderNavIcon = (name: string, icon: string, isActive: boolean) => {
    if (name === "Analytics") {
        return <BarChart3 className={cn("w-[24px] h-[24px] text-slate-400 transition-colors shrink-0", isActive && "text-white")} />;
    }
    if (name === "Notifications") {
        return <Bell className={cn("w-[24px] h-[24px] text-slate-400 transition-colors shrink-0", isActive && "text-white")} />;
    }
    if (name === "Leaderboard") {
        return <Trophy className={cn("w-[24px] h-[24px] text-amber-500 transition-colors shrink-0", isActive && "text-white")} />;
    }
